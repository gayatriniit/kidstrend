  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      ...
      <img src="resources/images/logo.png" class="img-circle" alt="kids" width="60" height="80"></ul>
        <li><a href="CustomerCheck">home</a></li>
        <li><a href="customerSignUp">contact us</a></li>
...
<center><img src="resources/images/productview.png" style="width:300px;height: 300px"></center>
</div>
<div>
<div class="container">
  <div>
...
<body ng-app="addToCartApp">
    <div ng-controller="addToCartCtrl">
        <a href="javascript:void(0)"  class="btn btn-danger" ng-click="addItemToCart(${product.product_id})">Add To kart</a>
        
        <a href="<spring:url value="/user/cart" />"
										  class="btn btn-success"><span class="glyphicon glyphicon-hand-right"></span>View Cart</a>
    </div>
    <script>
    ...
    cartApp.controller("addToCartCtrl", function ($scope, $http){
        ...
        $scope.removeItemFromCart = function (itemId) {
            $http.put('http://localhost:8080/kidstrend/usercart/cart/removeItem/'+itemId).success(function (data) {
        ...
        $scope.addItemToCart = function (itemId) {
        	 alert("test");
            $http.put('http://localhost:8080/kidstrend/usercart/cart/addItem/'+itemId).success(function () {
        ...
        $scope.refreshCartItems = function () {
            $http.get('http://localhost:8080/kidstrend/usercart/cart/refreshCart/'+$scope.cartId).success(function (data) {
               $scope.cart=data;
            });
        };
        ...
        $scope.clearCartItems = function () {
        	$http['delete']('http://localhost:8080/kidstrend/usercart/cart/clearCartItems/'+$scope.cartId).success(function (data) {$scope.refreshCartItems()});
        };
    });
</script>
</body>
