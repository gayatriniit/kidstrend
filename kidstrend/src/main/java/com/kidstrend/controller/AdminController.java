...
import com.kidstrend.model.UsersDetail;
import com.kidstrend.service.ItemDaoService;
import com.kidstrend.service.UsersDetailService;
@Controller
...
public String logout(HttpServletRequest request)
{
	...
	public String storeProduct(HttpServletRequest request,ModelMap model,@RequestParam("file") MultipartFile file, @Valid @ModelAttribute("shoes") Item p,BindingResult result)
	{
    	...
    	productService.addProduct(p);
         ...
         path = Paths.get("D:\\shuclu\\shoeclue\\src\\main\\webapp\\resources\\images\\"+p.getProduct_id()+".jpg");
System.out.println();
